...
#------ page 2------
    def Login(sf):
        ...
        sf.logo=PhotoImage(file="logo2001.png")
        ...
        sf.rg=Button(sf.loginf2,text="New to The Hogwarts Pizza",command=lambda:sf.Register(),fg="white",cursor="hand2",bg="#8c68c1",font=("cooper black",20),bd=6)
...
#--  page 5------
    def adminmain(sf):
        ...
        sf.c.pack()
        sf.logo=PhotoImage(file="logo100.png")
...
#--  page 7------
    def pizmain(sf):
        ...
        sf.name="  Rajat Tanwar | Shrey Madan"
...
#--  page 14------
 ...
 #-----  database-------               
    ...
    def orderpay(sf,x):
        ...
        messagebox.showinfo("Pay","Payment Method is Cash On Delivery")
